...
def parse_arguments():
    ...
    move_parser.add_argument("--verbose", action="store_true", help="Show detailed output")
    
    # Delete command
    delete_parser = subparsers.add_parser("delete", help="Delete files matching criteria")
    ...
    delete_parser.add_argument("--verbose", action="store_true", help="Show detailed output")
    ...
    remove_parser.add_argument("--verbose", action="store_true", help="Show detailed output")
    ...
    clean_parser.add_argument("--all", action="store_true", help="Remove all temporary files")
    clean_parser.add_argument("--verbose", action="store_true", help="Show detailed output")
    ...
    copy_parser.add_argument("--verbose", action="store_true", help="Show detailed output")
    
    # Find duplicates command
    dupes_parser = subparsers.add_parser("find-dupes", help="Find duplicate files")
    dupes_parser.add_argument("--path", required=True, help="Directory to search for duplicates")
    ...
    date_parser.add_argument("--format", default="%Y/%m/%d", help="Directory format (default: %%Y/%%m/%%d)")
    date_parser.add_argument("--use-created", action="store_true", help="Use created date instead of modified")
    ...
    search_parser.add_argument("--extensions", nargs="+", help="File extensions to search in")
    search_parser.add_argument("--case-sensitive", action="store_true", help="Use case-sensitive search")
    
    # Process extensions command
    process_parser = subparsers.add_parser("process-extensions", help="Process files by extension")
    process_parser.add_argument("--path", required=True, help="Directory to process")
    process_parser.add_argument("--dry-run", action="store_true", help="Simulate without making changes")
